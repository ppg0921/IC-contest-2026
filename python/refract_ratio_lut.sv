// =============================================================
// Auto-generated LUT: -coef/(-eta+coef)
// Indexed by {gx, gy, RI}
// All intermediate arithmetic quantized to Q4.12 after each step.
//
//   gx, gy : Q4.12 signed 16-bit  (= 2*u^7, 2*v^7)
//   RI     : 4-bit unsigned, range 2~15
//   output : Q4.12 signed 16-bit
//
//   Total entries : 2016
//   ratio range   : -0.933350 ~ -0.322998
// =============================================================

logic signed [15:0] ratio_lut;

always_comb begin
    unique case ({gx, gy, RI})  // 16 + 16 + 4 = 36-bit key
